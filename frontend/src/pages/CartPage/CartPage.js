...
// import "../ProductSinglePage/ProductSinglePage.scss"
        ...
        <div className="cart-ctable">
            ...
            {carts.map((cart, idx) => {
              return (
                <div className="cart-ctr py-4" key={cart?.PRODUCT_ID}>
                  ...
                  <div className="cart-ctd">
                    <span className="cart-ctxt">{cart?.TITLLE}</span>
                  </div>
                  <div className="cart-ctd">
                  ...
                  <div className="cart-ctd">
                    <div className="qty-change flex align-center">
                      <button
                        ...
                        onClick={() =>
                          dispatch(toggleCartQty({ id: cart?.PRODUCT_ID, type: "DEC" }))
                        }
                      >
                      ...
                      <button
                        ...
                        onClick={() =>
                          dispatch(toggleCartQty({ id: cart?.PRODUCT_ID, type: "INC" }))
                        }
                      >
                  ...
                  <div className="cart-ctd">
                    <button
                      ...
                      onClick={() => dispatch(removeFromCart(cart?.PRODUCT_ID))}
                    >
          ...
          <div className="cart-cfoot flex align-start justify-between py-3 bg-white">
            ...
            <div className="cart-cfoot-r flex flex-column justify-end">
             ...
             {userInfo && <Link to="/cart/checkout">
              <button
                type="button"
                className="checkout-btn text-white bg-black fs-16"
              >
                Check Out
              </button>
              </Link>}
